    ...
    <div class="row">
        <div class="col">
            <div class="card mt-4">
                <div class="card-body">
                    <?php
                    echo '<a href="./verMaquinaria.php?id=' . $datos->_id . '" class="btn btn-outline-primary margenBoton">
...
<path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm15 0a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1z" />
                    ...
                    <form action="../procesos/actualizarMaquinaria.php" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" class="form-control" id="tipo" name="tipo" value="<?php echo $datos->tipo ?>">
                        <label for="año">Año</label>
                        <input type="number" class="form-control" id="año" name="año" value="<?php echo $datos->año ?>">
                        <label for="placa">Placa</label>
                        <input type="text" class="form-control" id="placa" name="placa" value="<?php echo $datos->placa ?>">

                        <label for="peso">Categoria</label>
                        <select id="peso" class="form-control" name="peso" required>
                            <option value="<?php echo $datos->peso ?>"><?php echo $datos->peso ?></option>
                        ...
                        <input type="number" class="form-control" id="tiempo_mantenimiento" min="0" step="1" name="tiempo_mantenimiento" value="<?php echo $datos->tiempo_mantenimiento ?>">
                        <label for="Fecha_mantenimiento">Fecha de ultimo Mantenimiento</label>
                        <input type="date" class="form-control" id="Fecha_mantenimiento" name="Fecha_mantenimiento" value="<?php echo $datos->Fecha_mantenimiento ?>">
